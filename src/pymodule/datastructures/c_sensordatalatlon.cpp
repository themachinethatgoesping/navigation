...
void init_c_sensordatalatlon(py::module& m)
{
    ...
    py::class_<SensorDataLatLon, SensorData>(m, "SensorDataLatLon", DOC(themachinethatgoesping, navigation, datastructures, SensorDataLatLon))
        .def(py::init<const SensorData&, double, double>(),
             DOC(themachinethatgoesping, navigation, datastructures, SensorDataLatLon, SensorDataLatLon_2),
             py::arg("sensordata"),
             py::arg("latitude"),
             py::arg("longitude"))
        .def(py::init<const SensorDataUTM&>(),
             DOC(themachinethatgoesping, navigation, datastructures, SensorDataLatLon, SensorDataLatLon_3),
