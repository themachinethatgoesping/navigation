...
Offsets in the transducer frame (x forward, y starboard, z down,
metres).
Source: Kongsberg EM datagram formats 850-160692/V, appendices A–D.
Transmit subarrays: "0" = port, "1" = centre, "2" = starboard (or just
"0" for single-array). Receive phase centre: "RX". Returns an empty
map for unknown models.
