...
// Static conversion method implementations
SensordataLatLon SensordataUTM::to_sensordata_latlon(const SensordataUTM& data_utm)
{
    SensordataLatLon data(0, 0, data_utm.depth, data_utm.heave, data_utm.heading, data_utm.pitch, data_utm.roll);
...
SensordataUTM SensordataUTM::from_sensordata_latlon(const SensordataLatLon& data,
                                                   int                      setzone)
{
    SensordataUTM data_utm(0, 0, 0, 0, data.depth, data.heave, data.heading, data.pitch, data.roll);
