...
#include ".docstrings/sensordatalocalvector.doc.hpp"
...
/**
 * @brief A class to store a vector of SensordataLocal elements with timestamps.
 */
class SensordataLocalVector : public DataVector<SensordataLocal, SensordataLocalVector>
{
    using Base = DataVector<SensordataLocal, SensordataLocalVector>;
  ...
  public:
    ...
    // ----- file I/O -----
    static SensordataLocalVector from_stream(std::istream& is);
    ...
    __STREAM_DEFAULT_TOFROM_BINARY_FUNCTIONS__(SensordataLocalVector)
