...
#include ".docstrings/sensordatavector.doc.hpp"
...
/**
 * @brief A class to store a vector of Sensordata elements with timestamps.
 */
class SensordataVector : public DataVector<Sensordata, SensordataVector>
{
    using Base = DataVector<Sensordata, SensordataVector>;
  ...
  public:
    ...
    // ----- file I/O -----
    static SensordataVector from_stream(std::istream& is);
    ...
    __STREAM_DEFAULT_TOFROM_BINARY_FUNCTIONS__(SensordataVector)
